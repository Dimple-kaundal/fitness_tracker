        ...
        <div className="landingPage">
            ...
            <div className="lpbanner1">
                <div className="lpbanner1_content">
                    ...
                    <p>Track your progress, reach your goals, and become the best version of yourself with our fitness website. Start today and watch your journey to a healthier you unfold before your eyes.</p>
                ...
                <div className="lpbanner2_card">
                    ...
                    <div className="lpb2card lpb2card1">
                        <div className="lpb2card_content">
                            ...
                            <p>Clearly define what you want to achive, whether it's weight loss, muscle gain, or improve endurance.</p>
                        </div>
                    </div>
                    <div className="lpb2card lpb2card2">
                        <div className="lpb2card_content">
                            <h2>Create a plan:</h2>
                            <p>Breakdown your goals into smaller achievable steps. Follow a workout routine and meal plan that aligns with your objectives.</p>
                        </div>
                    </div>
            ...
            <div className="lpbanner3">
                <div className="lpbanner3_content">
                    <div className="lpbanner3_text">
                        ...
                        <p>Unlock your potential with our empowering workouts tailored to sculpt your best self.</p>
                        <Link to="/Workout"><button>View Workouts</button></Link>
                    </div>
             ...
             <div className="lpbanner4">
                <div className="lpbanner4_content">
                    ...
                    <div className="lpbanner4_text">
                        ...
                        <p>Fuel your journey to greatness with diet plans crafted to complement your fitness goals.</p>
                        <Link to="/DietPlan"><button>View Diet Plans</button></Link>
                    </div>
                </div>
            </div>
            ...
            <div className="lpbanner5">
                <div className="lpbanner5_content">
                    <div className="lpbanner5_text">
                        ...
                        <p>Elevate your performance with our curated selection of supplements, equipment, and smart wearables, designed to amplify every workout.</p>
                    ...
                    >
                        {Reviews.map((item) => (
                            <div key={item.id} className="reviewcard">
                                <img src={item.imageUrl} alt={item.profile} style={{ width: '20vh', borderRadius:'50%' }} />
